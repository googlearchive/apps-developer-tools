...
cr.define('extensions', function() {
  ...
  ExtensionErrorOverlay.prototype = {
    /**
     * The function used to show (or hide) an overlay. We need this to be
     * flexible so this can be used in both the App Developer Tool and
     * chrome:extensions.
     */
     ...
     * Initialize the page.
     */
    initializePage: function(showOverlayFunction) {
      var overlay = $('overlay');
      cr.ui.overlay.setupOverlay(overlay);
      cr.ui.overlay.globalInitialization();

      this.showOverlay = showOverlayFunction;
  ...
  ExtensionErrorOverlay.requestFileSourceResponse = function(result) {
    ...
    ExtensionErrorOverlay.getInstance().showOverlay(
